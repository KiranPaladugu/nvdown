...
public class ViewPanel extends JPanel {
	 ...
	 *            the weightx to set
	 */
	public ViewPanel setWeightX(final double weightX) {
	 ...
	 *            the weighty to set
	 */
	public ViewPanel setWeightY(final double weightY) {
	...
	public ViewPanel(final boolean expandble, final int expandPolicy) {
	...
	public ViewPanel setExpandable(final boolean expand) {
	...
	public ViewPanel setExpandPolicy(final int expandPolicy) {
		if (expandPolicy == NONE)
